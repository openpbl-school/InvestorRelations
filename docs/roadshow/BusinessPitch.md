...
Although companies are increasingly demanding professionals with these skills, the **offer** of specific courses and educational programs to develop them **is not enough** to meet the price and availability requirements required by **professionals** and **incoming** in the labor market.
...
The method considerably increases the **scalability** of the execution of courses that use a **learning strategy** proven **effective** in the development of behavioral skills: the *Problem Based Learning (PBL)*.
